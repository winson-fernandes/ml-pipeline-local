...
Or on UI: once "make serve" or "python -m src.serving.serve" is executed, start the UI with 127.0.0.1/docs and go to predict option under /predict and set the "Parameters" option and set the features to "
